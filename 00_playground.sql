...
select 
	substring(nome from 1 for 5) as nome_cortado,
	substring(nome, 2) as nome_cortado
from
	cliente

select upper(nome) as nome from cliente 

select nome, coalesce(cpf, 'Não informado') as cpf from cliente
